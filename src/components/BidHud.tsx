...
export default function BidHud({
  ...
  return (
    <div
      className="pointer-events-auto w-full rounded-xl bg-slate-950/70 p-3 backdrop-blur-md sm:w-auto"
      role="region"
    ...
    >
      ...
      <div className="mt-2.5 grid grid-cols-[1fr_auto_auto] gap-2">
        <motion.button
          ...
          disabled={!canBidNow}
          onClick={onBid}
          aria-label={canBidNow ? `Bid ${money(nextAmount)} (space)` : "Cannot bid"}
        ...
        <button
          ...
          onClick={onPass}
          aria-label="Pass on this player (P)"
          aria-keyshortcuts="p"
        ...
        <motion.button
          ...
          onClick={onSkip}
          aria-label="Skip this lot and fast-forward (S)"
          aria-keyshortcuts="s"
